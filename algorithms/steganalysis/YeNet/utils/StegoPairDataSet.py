...
class StegoPairDataset(Dataset):
    """
        ...
        Поззволяет применять парную Аугментацию к изображениям
    """
    ...
    def __init__(self, cover_dir, stego_dir, 
        ...
        print(f"Загружено {len(self.pairs)} пар изображений")
