...
% -------------------------------------------------------------------------
% [stego, distortion] = WOW(cover, payload) embeds a payload using simulated optimal
% coding for minimizing 'WOW' distortion - it uses default settings
%
% [stego, distortion] = WOW(cover, payload, config) - same as above but using
...
%
%   config.p            - single		- default -1	- holder norm parameter
